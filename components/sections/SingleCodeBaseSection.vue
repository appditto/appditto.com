<template>
  <section class="py-4 py-md-5" id="single-codebase">
    <b-row align-v="center" align-h="around">
      <b-col cols="11" md="5" lg="4" class="mt-4 mt-md-0 pl-md-4">
        <img src="~/assets/images/single-codebase.svg" alt="Single codebase" class="w-100" />
      </b-col>
      <b-col cols="12" md="7" class="px-md-4 px-lg-5">
        <div class="pl-md-4">
