<template>
  <div>
    <b-container fluid class="my-container-medium py-5">
      <h1 class="h2 w700 text-center my-4">Appditto LLC Natrium Privacy Policy</h1>
      <p class="p-policy">
        Appditto LLC ("Appditto LLC", "we", "our" or "us") respects your privacy and understands that it is important to you. We created this Privacy Policy to explain the types of information we collect through the Kalium and Natrium mobile applications released by us (the "App"), how we will use, disclose and protect this information once it is collected, and how you can opt in or opt out of some of our uses and disclosures of certain information relating to your use of the App.
        <br />
        <br />THE APP IS OWNED, OPERATED AND RELEASED BY APPDITTO LLC ONLY. APPDITTO LLC IS INDEPENDENT OF, AND OPERATES SEPARATELY FROM, ANY SOFTWARE WALLET THAT IS NOT RELEASED BY APPDITTO LLC (COLLECTIVELY, "SEPARATE TECHNOLOGIES"). FOR THE AVOIDANCE OF DOUBT, APPDITTO LLC DOES NOT OWN, DEVELOP, OPERATE, MAINTAIN OR SUPPORT ANY OF THE SEPARATE TECHNOLOGIES.
        <br />
        <br />Please read this Privacy Policy carefully to understand our policies and practices regarding information that we collect through the App about you and your use of the App and how we will treat it. If you do not agree with these policies and practices, do not download or use the App.
      </p>
      <h2 class="h3 w700 mt-5 mb-0">Changes to This Privacy Policy</h2>
      <p class="p-policy">
      ...
      <p class="p-policy">
        ...
        <br />
        <br />● We collect outside of the App, including, without limitation, on or through any other Appditto LLC apps or any Appditto LLC websites (including, without limitation, websites you may access through the App), through our social media pages or other presences on third-party websites, over the phone, by mail or in person; or
        <br />
        <br />● You provide to, or is collected by, any third party.
        <br />Our other apps and websites, and third parties, may have their own privacy policies, which we encourage you to read before using or providing information on, through or to them. For example, when you use the App on your device, certain third parties, such as your mobile device manufacturer or your mobile service provider may, separate from us, use automatic information collection technologies to collect information about you or your device, and that information they collect is not covered by this Privacy Policy. We do not control these third parties’ data collection or tracking technologies or how they may be used.
      </p>
      <h2 class="h3 w700 mt-5 mb-0">Children Under the Age of 13</h2>
      <p
        class="p-policy"
      >The App is not intended for children under 13 years of age, and we do not knowingly collect personal information from children under 13. If we learn we have collected or received personal information from a child under 13 without verification of parental consent, we will delete that information. If you believe we might have any information from or about a child under 13, please contact us at avengemediallc@gmail.com.</p>
      <h2 class="h3 w700 mt-5 mb-0">Information We Collect and How We Collect It</h2>
      <p class="p-policy">
        We may collect information from and about users of the App:
        <br />● Directly from you when you provide it to us in connection with the App;
        <br />● Automatically when you use the App.
        <br />
        <br />In general, you should be aware of the following Appditto LLC practices:
      ...
      <h2 class="h3 w700 mt-5 mb-0">Automatic Information Collection</h2>
      <p class="p-policy">
        ...
        <br />
        <br />● Device Information. We may collect and otherwise process information about your mobile device and internet connection on which and through which you use the App, including the device’s unique device identifier, IP address, operating system, browser type, and mobile network information. We collect and otherwise process your device’s unique device identifier solely as necessary for the legitimate interest of recording your agreement to this Privacy Policy for the App and collect and otherwise process your device’s IP address solely as necessary for the legitimate interest of providing, operating, maintaining and developing the App. If we process your information based on our legitimate interests as explained above, you may have the right under certain laws and regulations to object to such processing and may contact us to inform us of your objection via email at avengemediallc@gmail.com.
      </p>
      <h2
        class="h3 w700 mt-5 mb-0"
      >Clarifications Regarding Certain Information We Do Not Collect or See</h2>
      <p class="p-policy">
        ...
        <br />● Any Banano/Nano currency that you choose to hold, store, manage, receive, send or transmit using the App, and any balance or transaction information relating to it, are never held, stored, known, managed, received, sent or transmitted by Appditto LLC. You are solely responsible for the security and privacy of your own Nano currency and related information.
        <br />● We do not track the location of your device through the App.
        <br />● We do not collect your name or contact information through the App.
        <br />● We do not retain copies of your transaction history, so if you delete the App your transaction history will be permanently lost.
      </p>
      <h2 class="h3 w700 mt-5 mb-0">How We Use Your Information</h2>
      <p class="p-policy">
        We use the information that we collect about you through the App to:
        <br />● Provide you with, operate and maintain the App and its contents, and any other information, products or services that you request from us;
        <br />● Fulfill any other purpose for which you provide it;
        <br />● Recognize your device when you use the App.
      </p>
      <h2 class="h3 w700 mt-5 mb-0">Disclosure of Your Information</h2>
      <p class="p-policy">
        ...
        <br />
        <br />● To a buyer or other successor in the event of a merger, divestiture, restructuring, reorganization, dissolution or other sale or transfer of some or all of Appditto LLC’s assets, whether as a going concern or as part of bankruptcy, liquidation or similar proceeding, in which personal information held by Appditto LLC about the App users is among the assets transferred;
        <br />● To fulfill the purpose(s) for which you provide it;
        ...
        <br />● If we believe disclosure is necessary or appropriate to protect the rights, property or safety of Appditto LLC, our customers or others (which includes exchanging information with other companies and organizations for the purposes of fraud protection).
      </p>
      <h2 class="h3 w700 mt-5 mb-0">Data Security</h2>
      <p class="p-policy">
        ...
        <br />
        <br />The safety and security of your information also depends on you. Where the App has given you a Wallet Seed, you are solely responsible for keeping this Wallet Seed confidential, as it can be used to access your Wallet and any Banano/Nano currency you store in your Wallet. You should not share your Wallet Seed with anyone. We do not receive, collect, record, store or have access to your Wallet Seed and we cannot recover them for you if you lose them.
      </p>
      <h2 class="h3 w700 mt-5 mb-0">Contact Information</h2>
      <p
        class="p-policy"
      >To ask questions or comment about this Privacy Policy or our privacy practices, you can contact us via email at hello@appditto.com</p>
      <h3 class="h4 w700 mt-5 mb-0 text-center">Effective Date: January 31st, 2019</h3>
    </b-container>
  </div>
</template>
<style scoped>
