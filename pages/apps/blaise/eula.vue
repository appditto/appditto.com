<template>
  <div class="w-full">
    <div class="container-md px-6 py-12 md:py-20">
      <h1 class="text-3xl md:text-4xl leading-tight text-center font-bold">{{blaiseEULA.title}}</h1>
      <div class="content" v-html="blaiseEULA.html"></div>
    </div>
  </div>
</template>
<script>
...
export default {
    ...
    const getSinglePost = async () => {
      try {
        return await axios.get(
          'https://appditto.com/api/ghost/posts/blaise-mobile-application-end-user-license-agreement'
        )
      } catch (e) {
        console.error(e)
      }
  ...
  data() {
    return {
      homePageDescription:
        'Blaise is owned, operated and released by Appditto. This end user license agreement is a binding agreement between us and our users.',
      homePageTitle: 'Appditto | Blaise End User License Agreement ',
