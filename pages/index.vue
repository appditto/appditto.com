      ...
      <b-row align-v="center" align-h="center">
        <b-col cols="12" md="6">
          ...
          <b-row class="px-3 justify-content-center justify-content-md-start">
            <b-btn variant="primary" size="lg" rounded class="w800 px-5 mt-2"
              >Let's Talk</b-btn
            >
          </b-row>
        </b-col>
        <b-col cols="12" md="6" class="mt-4 mt-md-0">
          <img src="~/static/images/hero-phones.png" alt="Hero" class="w-100" />
        </b-col>
      </b-row>
    </section>
    <!-- Single codebase -->
      ...
      <b-row align-v="center" align-h="between">
        ...
        <b-col cols="12" md="6" class="px-md-5">
          ...
          <h5 class="w400">
            ...
            built from a single code base. That means less maintenance, better
            and more continuous user engagement.
          </h5>
        </b-col>
      </b-row>
    </section>
